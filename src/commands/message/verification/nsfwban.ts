...
module.exports = {
    ...
    async execute({ client, message, args, guildData }: MessageCommandArgs) {
        ...
        const { banEmbed, nsfwBanRoleEmbed, nsfwRoleEmbed, logEmbed } = await getEmbeds(member, message.member, reason);
        ...
        const embeds = [banEmbed, nsfwBanRoleEmbed, nsfwRoleEmbed];
